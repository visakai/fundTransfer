...
<body link="#FFFF99" vlink="#FFFF99" alink="#FFFF99">
	...
	<div id="div1">
		<form id="senderForm" name="senderForm" method="post" action=""
			...
			<br> <font size="2" family="Source Code Pro"> Step 1 of 3
				- Enter Sender Details</font> </br> </br>
			<table border="0" align="center" width="38%"
				...
				<tr>
					<td width="45%" align="left" padding-bottom="225px"
						style="font-size: 10pt; font-family: Source Code Pro">&nbsp;&nbsp;&nbsp;
						Sender's Account Number: <font color="red">*</font>
					</td>

					<td align="left"><input type="text" name="accNo" id="accNo"
						value="<%=session.getAttribute("senderPAN") == null ? "" : session
					.getAttribute("senderPAN")%>"></input>
