...
<div id="div1">
	<form id="recipientForm" name="recipientForm" method="post" action=""
		...
		<table border="0" width="50%" align="center">
			<tr>
				...
				<td width="16.6%"><a href="recipient.jsp"><img
						src="images/bankIcon-green.png" style="width: 80px; height: 65px;" /></a></td>
			</tr>
			<tr>
		...
		<br> <font size="2" family="Source Code Pro"> Step 2 of 3
			- Enter Recipient's Visa Card Number</font> <br> </br>
		<table border="0" align="center" width="38%"
			...
			<tr>
				<td
					style="font-size: 10pt; margin-left: 500px; font-family: Source Code Pro"
					width="20%" align="left">&nbsp;&nbsp;&nbsp; Recipient Name:</td>
				<td align="left" width="20%"><input type="text" size="19"
					name="recipientName" id="recipientName" value="" /></td>
			</tr>
			<tr>
				<td style="font-size: 10pt; font-family: Source Code Pro"
					width="25%" align="left">&nbsp;&nbsp;&nbsp; Recipient Card
		...
		<table border="0" width="55%" align="center">
			<tr>
				<td style="font-size: 9pt; font-family: Source Code Pro">Under
					the hood: <input type="checkbox" id="cbxShowHide"
					name="cbxShowHide" value="request" style="cursor: pointer;"
...
<form name="showResponseForm" id="showResponseForm">
	<div id="divshowResponse"
		...
		<table border="0" width="80%" align="center">
			...
			<tr>
				<td align="left"><textarea readonly rows="20" cols="80"
						id="request"
						style="resize: none; scroll: true; background-color: black; color: #3bd6c6"></textarea></td>
				<td align="right"><textarea readonly rows="20" cols="80"
						id="response"
						style="resize: none; scroll: true; background-color: black; color: #3bd6c6"></textarea></td>
			</tr>
		</table>
